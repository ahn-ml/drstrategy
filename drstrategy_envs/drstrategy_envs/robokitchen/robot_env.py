...
from drstrategy_envs.robokitchen import mujoco_env
from drstrategy_envs.robokitchen.base_robot import BaseRobot
from drstrategy_envs.robokitchen.utils.configurable import import_class_from_path
from drstrategy_envs.robokitchen.utils.constants import MODELS_PATH
...
class RobotEnv(mujoco_env.MujocoEnv):
    ...
    def __init__(self,
        ...
        try:
            from drstrategy_envs.robokitchen.franka.utils.remote_viz import RemoteViz
