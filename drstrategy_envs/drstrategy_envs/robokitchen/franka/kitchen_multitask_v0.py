...
from drstrategy_envs.robokitchen import robot_env
...
class KitchenV0(robot_env.RobotEnv):
    ...
    ROBOTS = {"robot": "drstrategy_envs.robokitchen.franka.robot.franka_robot:Robot_VelAct"}
    EE_CTRL_MODEL = os.path.join(
        os.path.dirname(__file__), "assets/franka_kitchen_ee_ctrl.xml"
    )
    JOINT_POSITION_CTRL_MODEL = os.path.join(
        os.path.dirname(__file__),
        "assets/franka_kitchen_joint_position_ctrl.xml",
    )
    TORQUE_CTRL_MODEL = os.path.join(
        os.path.dirname(__file__),
        "assets/franka_kitchen_torque_ctrl.xml",
    )
    CTLR_MODES_DICT = dict(
        primitives=dict(
            model=EE_CTRL_MODEL,
            robot={
                "robot": "drstrategy_envs.robokitchen.franka.robot.franka_robot:Robot_Unconstrained"
            },
        ),
        end_effector=dict(
            model=EE_CTRL_MODEL,
        ...
        joint_position=dict(
            ...
            robot={
                "robot": "drstrategy_envs.robokitchen.franka.robot.franka_robot:Robot_PosAct"
            },
        ),
        joint_velocity=dict(
            model=JOINT_POSITION_CTRL_MODEL,
            robot={
                "robot": "drstrategy_envs.robokitchen.franka.robot.franka_robot:Robot_VelAct"
            },
        ),
        vices=dict(
            model=JOINT_POSITION_CTRL_MODEL,
