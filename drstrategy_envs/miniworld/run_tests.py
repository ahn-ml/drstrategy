...
from drstrategy_envs.miniworld.wrappers import PyTorchObsWrapper, GreyscaleWrapper
from drstrategy_envs.miniworld.entity import TextFrame
...
class TestText(drstrategy_envs.miniworld.envs.threerooms.ThreeRooms):
     def _gen_world(self):
         super()._gen_world()
...
for env_id in drstrategy_envs.miniworld.envs.env_ids:
