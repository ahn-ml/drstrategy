...
SE_maxstep=700
CUDA_VISIBLE_DEVICES=0 python eval.py configs=memorymaze_pixels agent=p2eDrStrategy domain=memorymaze task=rnavmemorymaze3Ddifffloortextureskynowalltexture_$task \
